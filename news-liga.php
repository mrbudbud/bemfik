                            ...
                            <div class="main_about_content"><br><br>
                                <div class="row">
                                    <div class="col-sm-5">
                                        ...
                                        <br><br><br><br><img src="assets/images/fotokonten/1.jpg" style="width:400px;" alt="" />
                                        </div>
                                    </div>
                                    <div class="col-sm-7 wow fadeInRight" data-wow-duration="700ms">
                                        <div class="single_about_right_content">
                                            ...
                                            <p>DD-MM-YYY</p>
                                            <p>League FIK Competition merupakan ajang perlombaan yang bermaksud 
                                            untuk mempersatukan keluarga besar Fakultas Ilmu Komputer </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
